                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <!--  <input v-model="editdata.tagName" type="text" /> -->
                            <Input   v-model="editdata.tagName" placeholder="Edit tag name" clearable style="width: 200px" class="my-3"/>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <!--  <input v-model="data.tagName" type="text" /> -->
                            <Input   v-model="data.tagName" placeholder="Enter tag title" clearable style="width: 200px" class="my-3"/>
